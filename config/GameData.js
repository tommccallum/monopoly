...
module.exports = {
    ...
    squares: [
        ...
        { group: "property", name: "Old Kent Road", purchase_value: 60, house_purchase_price:50, hotel_purchase_price:50 },
        { group: "property", name: "Whitechapel Road", purchase_value: 60, house_purchase_price:50, hotel_purchase_price:50 },
        { group: "tax", name: "Income Tax", purchase_value: 200 },
        { group: "station", name: "King's Cross Station", puchase_value: 200 },
        { group: "property", name: "The Angel Islington", purchase_value: 100, house_purchase_price:50, hotel_purchase_price:50 },
        { group: "chance", name: "Chance" },
        { group: "property", name: "Euston Road", purchase_value: 100, house_purchase_price:50, hotel_purchase_price:50 },
        { group: "property", name: "Pentonville Road", purchase_value: 120, house_purchase_price:50, hotel_purchase_price:50 },
        { group: "jail", name: "Jail", purchase_value: 0 },
        { group: "property", name: "Pall Mall", purchase_value: 140, house_purchase_price:100, hotel_purchase_price:100 },
        { group: "utility", name: "Electric Company", purchase_value: 150 },
        { group: "property", name: "Whitehall", purchase_value: 140, house_purchase_price:100, hotel_purchase_price:100 },
        { group: "property", name: "Northumberland Avenue", purchase_value: 160, house_purchase_price:100, hotel_purchase_price:100 },
        { group: "station", name: "Marylebone Station", purchase_value: 200 },
        { group: "property", name: "Bow Street", purchase_value: 180, house_purchase_price:100, hotel_purchase_price:100 },
        { group: "communitychest", name: "Community Chest" },
        { group: "property", name: "Marlborough Street", purchase_value: 180, house_purchase_price:100, hotel_purchase_price:100 },
        { group: "property", name: "Vine Street", purchase_value: 200, house_purchase_price:100, hotel_purchase_price:100 },
        { group: "freeparking", name: "Free Parking" },
        { group: "property", name: "Strand", purchase_value: 220, house_purchase_price:150, hotel_purchase_price:150 },
        { group: "chance", name: "Chance" },
        { group: "property", name: "Fleet Street", purchase_value: 220, house_purchase_price:150, hotel_purchase_price:150 },
        { group: "property", name: "Trafalgar Square", purchase_value: 240, house_purchase_price:150, hotel_purchase_price:150 },
        { group: "station", name: "Fenchurch Station", purchase_value: 200 },
        { group: "property", name: "Leicester Square", purchase_value: 260, house_purchase_price:150, hotel_purchase_price:150 },
        { group: "property", name: "Coventry Street", purchase_value: 260, house_purchase_price:150, hotel_purchase_price:150 },
        { group: "utility", name: "Water Works", purchase_value: 150 },
        { group: "property", name: "Picadilly", purchase_value: 280, house_purchase_price:150, hotel_purchase_price:150 },
        { group: "gotojail", name: "Go to Jail" },
        { group: "property", name: "Regent Street", purchase_value: 300, house_purchase_price:200, hotel_purchase_price:200 },
        { group: "property", name: "Oxford Street", purchase_value: 300, house_purchase_price:200, hotel_purchase_price:200 },
        { group: "communitychest", name: "Community Chest" },
        { group: "property", name: "Bond Street", purchase_value: 320, house_purchase_price:200, hotel_purchase_price:200 },
        { group: "station", name: "Liverpool St. Station", purchase_value: 200 },
        { group: "chance", name: "Chance" },
        { group: "property", name: "Park Lane", purchase_value: 350, house_purchase_price:200, hotel_purchase_price:200 },
        { group: "tax", name: "Super Tax", purchase_value: 100 },
        { group: "property", name: "Mayfair", purchase_value: 400, house_purchase_price:200, hotel_purchase_price:200 }
    ],
    tokens: [
        { name: "Cannon" },
        { name: "Battleship" },
